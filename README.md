...
> [!IMPORTANT]
>
> Nats.ws is now part of [nats.js](https://github.com/nats-io/nats.js). Please
...
`ignoreServerUpdates` connection option. Of course in this case you are
...
specifications. The third server connects using `wss://` as that is the default
protocol.
